 ...
 * @subpackage Accessible_Combobox_Gravity_Forms/public
 */
 ...
 */
class Accessible_Combobox_Gravity_Forms_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/accessible-combobox-gravity-forms-public.css', array(), $this->version, 'all' );
